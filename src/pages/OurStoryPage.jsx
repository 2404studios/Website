...
export default function OurStoryPage({ isActive }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Left Side: Large Image - Synced with Text */}
        <div className="w-full md:w-1/2 flex justify-center md:justify-end">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{ backgroundColor: SUB_PAGES[currentIdx].color }}
            >
              <img
                src={SUB_PAGES[currentIdx].image}
                alt={SUB_PAGES[currentIdx].title}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="relative flex w-full" data-no-swipe>
                ...
                >
                  <p
                    className="text-white text-base md:text-xl leading-relaxed font-bold text-center md:text-left pr-4 md:pr-0"
                    data-no-swipe
                  >
                ...
                >
                  <div
                    className="relative w-[2px] h-full bg-white/10 rounded-full"
                    data-no-swipe
                  >
                    <motion.div
                      drag="y"
