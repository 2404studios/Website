...
export default function SocialPage({ isActive }) {
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://instagram.com/2404_studios',
      icon: (
    ...
    {
      name: 'YouTube',
      url: 'https://youtube.com/@2404studios',
      icon: (
    ...
    {
      name: 'Discord',
      url: 'https://discord.gg/2404studios',
      icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Substack',
      url: 'https://substack.com/@2404studios',
      icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor">
